# Application des surnoms des enseignants - Step5
...
Nous allons créer un seeder pour les sections et un autre pour les enseignants :

<img src="./doc/images/create-seeder-teacher.png" style="width:50%"/>

A vous d'utiliser le CLI pour générer le seeder des sections.

Nous allons maintenant compléter les 2 seeders :
...
<img src="./doc/images/run-seeder.png" style="width:30%"/>
...
## Création d'une factory pour les enseignants via le CLI

<img src="./doc/images/create-factory-teacher.png" style="width:30%"/>
...
Maintenant nous devons exécuter les seeders.

Pour cela, nous devons supprimer puis recréer toutes les tables puis exécuter les seeders.

Nous pouvons faire cela en seulement une commande !

<img src="./doc/images/make-migration-refresh-sedd.png" style="width:50%"/>

## Etat de l'application à la fin de cette étape

Notre application a toujours qu'une page à savoir la homepage.

<img src="./doc/images/step5-fin.png" style="width:60%"/>

## Prochaine étape

Dans la prochaine étape <a href="https://github.com/GregLeBarbar/app-teachers-adonisjs-2026/tree/step6">step6</a>, nous allons afficher les détails d'un enseignant.
